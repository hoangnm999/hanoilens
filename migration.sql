...
create table if not exists equipment_points (
  ...
  exchange_points  integer not null default 1000,  -- điểm cần để đổi 1 ngày free
  description     text,
...
insert into equipment_points (name, category, points_per_day, exchange_points, description, status) values
